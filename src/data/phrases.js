...
export const POPULAR_COUNTRIES = [
  { code: 'TW', name: { ja: '台湾', en: 'Taiwan', th: 'ไต้หวัน' }, flag: '🇹🇼' },
  { code: 'KR', name: { ja: '韓国', en: 'South Korea', th: 'เกาหลีใต้' }, flag: '🇰🇷' },
  { code: 'US', name: { ja: 'アメリカ', en: 'United States', th: 'สหรัฐอเมริกา' }, flag: '🇺🇸' },
  { code: 'TH', name: { ja: 'タイ', en: 'Thailand', th: 'ไทย' }, flag: '🇹🇭' },
  { code: 'CN', name: { ja: '中国', en: 'China', th: 'จีน' }, flag: '🇨🇳' },
  { code: 'HK', name: { ja: '香港', en: 'Hong Kong', th: 'ฮ่องกง' }, flag: '🇭🇰' },
  { code: 'SG', name: { ja: 'シンガポール', en: 'Singapore', th: 'สิงคโปร์' }, flag: '🇸🇬' },
  { code: 'AU', name: { ja: 'オーストラリア', en: 'Australia', th: 'ออสเตรเลีย' }, flag: '🇦🇺' },
  { code: 'GB', name: { ja: 'イギリス', en: 'United Kingdom', th: 'สหราชอาณาจักร' }, flag: '🇬🇧' },
  { code: 'FR', name: { ja: 'フランス', en: 'France', th: 'ฝรั่งเศส' }, flag: '🇫🇷' },
  { code: 'IT', name: { ja: 'イタリア', en: 'Italy', th: 'อิตาลี' }, flag: '🇮🇹' },
  { code: 'ES', name: { ja: 'スペイン', en: 'Spain', th: 'สเปน' }, flag: '🇪🇸' },
  { code: 'DE', name: { ja: 'ドイツ', en: 'Germany', th: 'เยอรมนี' }, flag: '🇩🇪' },
  { code: 'CA', name: { ja: 'カナダ', en: 'Canada', th: 'แคนาดา' }, flag: '🇨🇦' },
  { code: 'PH', name: { ja: 'フィリピン', en: 'Philippines', th: 'ฟิลิปปินส์' }, flag: '🇵🇭' },
  { code: 'VN', name: { ja: 'ベトナム', en: 'Vietnam', th: 'เวียดนาม' }, flag: '🇻🇳' },
  { code: 'MY', name: { ja: 'マレーシア', en: 'Malaysia', th: 'มาเลเซีย' }, flag: '🇲🇾' },
  { code: 'ID', name: { ja: 'インドネシア', en: 'Indonesia', th: 'อินโดนีเซีย' }, flag: '🇮🇩' },
