(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();const Jh={};let ta="";function st(r,e){Jh[r]=e}function ve(r,e=!0){if(ta===r)return;const t=Jh[r];if(!t){console.warn(`Route not found: ${r}`),ve("/");return}ta=r,e&&(window.location.hash=r);const n=document.getElementById("page-content");n&&(n.style.opacity="0",n.style.transform="translateY(8px)",setTimeout(async()=>{try{const s=await t.render();n.innerHTML=s,n.style.opacity="1",n.style.transform="translateY(0)",t.init&&t.init(),rg(r),window.scrollTo({top:0})}catch(s){console.error("Page render error:",s)}},150))}function rg(r){document.querySelectorAll(".nav-item").forEach(n=>{const s=n.getAttribute("data-route");n.classList.toggle("active",s===r)});const e={"/":"旅のしおり","/flashcard":"単語カード","/checklist":"持ち物チェック","/schedule":"スケジュール","/research":"リサーチノート","/budget":"費用メモ","/emergency":"緊急連絡先","/omiyage":"お土産リスト","/settings":"設定","/trip/new":"新しい旅行","/trip/edit":"旅行を編集","/share":"共有しおり"},t=document.querySelector(".header-title-text");t&&(t.textContent=e[r]||"旅のしおり")}function Jl(){return ta}window.addEventListener("hashchange",()=>{const r=window.location.hash.replace("#","")||"/";ve(r,!1)});var Yl={};/**
 * @license
