 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cy{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(ly(t)){const n=t.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(t=>t).join(" ")}}function ly(r){const e=r.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ua="@firebase/app",ou="0.10.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qy(r){pn(new Ut("platform-logger",e=>new cy(e),"PRIVATE")),pn(new Ut("heartbeat",e=>new Hy(e),"PRIVATE")),tt(ua,ou,r),tt(ua,ou,"esm2017"),tt("fire-js","")}Qy("");var Jy="firebase",Yy="10.14.1";/**
 * @license
...
*/var yd,$r,_d,si,fa,vd,Id,Td;(function(){var r,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(a,u,d){return a==Array.prototype||a==Object.prototype||(a[u]=d.value),a};function t(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof Ks=="object"&&Ks];for(var u=0;u<a.length;++u){var d=a[u];if(d&&d.Math==Math)return d}throw Error("Cannot find global object")}var n=t(this);function s(a,u){if(u)e:{var d=n;a=a.split(".");for(var m=0;m<a.length-1;m++){var A=a[m];if(!(A in d))break e;d=d[A]}a=a[a.length-1],m=d[a],u=u(m),u!=m&&u!=null&&e(d,a,{configurable:!0,writable:!0,value:u})}}function i(a,u){a instanceof String&&(a+="");var d=0,m=!1,A={next:function(){if(!m&&d<a.length){var C=d++;return{value:u(C,a[C]),done:!1}}return m=!0,{done:!0,value:void 0}}};return A[Symbol.iterator]=function(){return A},A}s("Array.prototype.values",function(a){return a||function(){return i(this,function(u,d){return d})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},c=this||self;function l(a){var u=typeof a;return u=u!="object"?u:a?Array.isArray(a)?"array":u:"null",u=="array"||u=="object"&&typeof a.length=="number"}function h(a){var u=typeof a;return u=="object"&&a!=null||u=="function"}function f(a,u,d){return a.call.apply(a.bind,arguments)}function p(a,u,d){if(!a)throw Error();if(2<arguments.length){var m=Array.prototype.slice.call(arguments,2);return function(){var A=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(A,m),a.apply(u,A)}}return function(){return a.apply(u,arguments)}}function g(a,u,d){return g=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?f:p,g.apply(null,arguments)}function E(a,u){var d=Array.prototype.slice.call(arguments,1);return function(){var m=d.slice();return m.push.apply(m,arguments),a.apply(this,m)}}function P(a,u){function d(){}d.prototype=u.prototype,a.aa=u.prototype,a.prototype=new d,a.prototype.constructor=a,a.Qb=function(m,A,C){for(var F=Array(arguments.length-2),ie=2;ie<arguments.length;ie++)F[ie-2]=arguments[ie];return u.prototype[A].apply(m,F)}}function D(a){const u=a.length;if(0<u){const d=Array(u);for(let m=0;m<u;m++)d[m]=a[m];return d}return[]}function k(a,u){for(let d=1;d<arguments.length;d++){const m=arguments[d];if(l(m)){const A=a.length||0,C=m.length||0;a.length=A+C;for(let F=0;F<C;F++)a[A+F]=m[F]}else a.push(m)}}class ${constructor(u,d){this.i=u,this.j=d,this.h=0,this.g=null}get(){let u;return 0<this.h?(this.h--,u=this.g,this.g=u.next,u.next=null):u=this.i(),u}}function j(a){return/^[\s\xa0]*$/.test(a)}function L(){var a=c.navigator;return a&&(a=a.userAgent)?a:""}function B(a){return B[" "](a),a}B[" "]=function(){};var V=L().indexOf("Gecko")!=-1&&!(L().toLowerCase().indexOf("webkit")!=-1&&L().indexOf("Edge")==-1)&&!(L().indexOf("Trident")!=-1||L().indexOf("MSIE")!=-1)&&L().indexOf("Edge")==-1;function O(a,u,d){for(const m in a)u.call(d,a[m],m,a)}function I(a,u){for(const d in a)u.call(void 0,a[d],d,a)}function y(a){const u={};for(const d in a)u[d]=a[d];return u}const v="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function w(a,u){let d,m;for(let A=1;A<arguments.length;A++){m=arguments[A];for(d in m)a[d]=m[d];for(let C=0;C<v.length;C++)d=v[C],Object.prototype.hasOwnProperty.call(m,d)&&(a[d]=m[d])}}function b(a){var u=1;a=a.split(":");const d=[];for(;0<u&&a.length;)d.push(a.shift()),u--;return a.length&&d.push(a.join(":")),d}function S(a){c.setTimeout(()=>{throw a},0)}function T(){var a=yo;let u=null;return a.g&&(u=a.g,a.g=a.g.next,a.g||(a.h=null),u.next=null),u}class lt{constructor(){this.h=this.g=null}add(u,d){const m=_r.get();m.set(u,d),this.h?this.h.next=m:this.g=m,this.h=m}}var _r=new $(()=>new Lm,a=>a.reset());class Lm{constructor(){this.next=this.g=this.h=null}set(u,d){this.h=u,this.g=d,this.next=null}reset(){this.next=this.g=this.h=null}}let vr,Ir=!1,yo=new lt,el=()=>{const a=c.Promise.resolve(void 0);vr=()=>{a.then(Om)}};var Om=()=>{for(var a;a=T();){try{a.h.call(a.g)}catch(d){S(d)}var u=_r;u.j(a),100>u.h&&(u.h++,a.next=u.g,u.g=a)}Ir=!1};function Et(){this.s=this.s,this.C=this.C}Et.prototype.s=!1,Et.prototype.ma=function(){this.s||(this.s=!0,this.N())},Et.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function Ae(a,u){this.type=a,this.g=this.target=u,this.defaultPrevented=!1}Ae.prototype.h=function(){this.defaultPrevented=!0};var Mm=function(){if(!c.addEventListener||!Object.defineProperty)return!1;var a=!1,u=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const d=()=>{};c.addEventListener("test",d,u),c.removeEventListener("test",d,u)}catch{}return a}();function Tr(a,u){if(Ae.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a){var d=this.type=a.type,m=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;if(this.target=a.target||a.srcElement,this.g=u,u=a.relatedTarget){if(V){e:{try{B(u.nodeName);var A=!0;break e}catch{}A=!1}A||(u=null)}}else d=="mouseover"?u=a.fromElement:d=="mouseout"&&(u=a.toElement);this.relatedTarget=u,m?(this.clientX=m.clientX!==void 0?m.clientX:m.pageX,this.clientY=m.clientY!==void 0?m.clientY:m.pageY,this.screenX=m.screenX||0,this.screenY=m.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=typeof a.pointerType=="string"?a.pointerType:jm[a.pointerType]||"",this.state=a.state,this.i=a,a.defaultPrevented&&Tr.aa.h.call(this)}}P(Tr,Ae);var jm={2:"touch",3:"pen",4:"mouse"};Tr.prototype.h=function(){Tr.aa.h.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var Ps="closure_listenable_"+(1e6*Math.random()|0),Fm=0;function Bm(a,u,d,m,A){this.listener=a,this.proxy=null,this.src=u,this.type=d,this.capture=!!m,this.ha=A,this.key=++Fm,this.da=this.fa=!1}function Cs(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function ks(a){this.src=a,this.g={},this.h=0}ks.prototype.add=function(a,u,d,m,A){var C=a.toString();a=this.g[C],a||(a=this.g[C]=[],this.h++);var F=vo(a,u,m,A);return-1<F?(u=a[F],d||(u.fa=!1)):(u=new Bm(u,this.src,C,!!m,A),u.fa=d,a.push(u)),u};function _o(a,u){var d=u.type;if(d in a.g){var m=a.g[d],A=Array.prototype.indexOf.call(m,u,void 0),C;(C=0<=A)&&Array.prototype.splice.call(m,A,1),C&&(Cs(u),a.g[d].length==0&&(delete a.g[d],a.h--))}}function vo(a,u,d,m){for(var A=0;A<a.length;++A){var C=a[A];if(!C.da&&C.listener==u&&C.capture==!!d&&C.ha==m)return A}return-1}var Io="closure_lm_"+(1e6*Math.random()|0),To={};function tl(a,u,d,m,A){if(Array.isArray(u)){for(var C=0;C<u.length;C++)tl(a,u[C],d,m,A);return null}return d=sl(d),a&&a[Ps]?a.K(u,d,h(m)?!!m.capture:!1,A):Um(a,u,d,!1,m,A)}function Um(a,u,d,m,A,C){if(!u)throw Error("Invalid event type");var F=h(A)?!!A.capture:!!A,ie=wo(a);if(ie||(a[Io]=ie=new ks(a)),d=ie.add(u,d,m,F,C),d.proxy)return d;if(m=$m(),d.proxy=m,m.src=a,m.listener=d,a.addEventListener)Mm||(A=F),A===void 0&&(A=!1),a.addEventListener(u.toString(),m,A);else if(a.attachEvent)a.attachEvent(rl(u.toString()),m);else if(a.addListener&&a.removeListener)a.addListener(m);else throw Error("addEventListener and attachEvent are unavailable.");return d}function $m(){function a(d){return u.call(a.src,a.listener,d)}const u=qm;return a}function nl(a,u,d,m,A){if(Array.isArray(u))for(var C=0;C<u.length;C++)nl(a,u[C],d,m,A);else m=h(m)?!!m.capture:!!m,d=sl(d),a&&a[Ps]?(a=a.i,u=String(u).toString(),u in a.g&&(C=a.g[u],d=vo(C,d,m,A),-1<d&&(Cs(C[d]),Array.prototype.splice.call(C,d,1),C.length==0&&(delete a.g[u],a.h--)))):a&&(a=wo(a))&&(u=a.g[u.toString()],a=-1,u&&(a=vo(u,d,m,A)),(d=-1<a?u[a]:null)&&Eo(d))}function Eo(a){if(typeof a!="number"&&a&&!a.da){var u=a.src;if(u&&u[Ps])_o(u.i,a);else{var d=a.type,m=a.proxy;u.removeEventListener?u.removeEventListener(d,m,a.capture):u.detachEvent?u.detachEvent(rl(d),m):u.addListener&&u.removeListener&&u.removeListener(m),(d=wo(u))?(_o(d,a),d.h==0&&(d.src=null,u[Io]=null)):Cs(a)}}}function rl(a){return a in To?To[a]:To[a]="on"+a}function qm(a,u){if(a.da)a=!0;else{u=new Tr(u,this);var d=a.listener,m=a.ha||a.src;a.fa&&Eo(a),a=d.call(m,u)}return a}function wo(a){return a=a[Io],a instanceof ks?a:null}var bo="__closure_events_fn_"+(1e9*Math.random()>>>0);function sl(a){return typeof a=="function"?a:(a[bo]||(a[bo]=function(u){return a.handleEvent(u)}),a[bo])}function Se(){Et.call(this),this.i=new ks(this),this.M=this,this.F=null}P(Se,Et),Se.prototype[Ps]=!0,Se.prototype.removeEventListener=function(a,u,d,m){nl(this,a,u,d,m)};function Ve(a,u){var d,m=a.F;if(m)for(d=[];m;m=m.F)d.push(m);if(a=a.M,m=u.type||u,typeof u=="string")u=new Ae(u,a);else if(u instanceof Ae)u.target=u.target||a;else{var A=u;u=new Ae(m,a),w(u,A)}if(A=!0,d)for(var C=d.length-1;0<=C;C--){var F=u.g=d[C];A=xs(F,m,!0,u)&&A}if(F=u.g=a,A=xs(F,m,!0,u)&&A,A=xs(F,m,!1,u)&&A,d)for(C=0;C<d.length;C++)F=u.g=d[C],A=xs(F,m,!1,u)&&A}Se.prototype.N=function(){if(Se.aa.N.call(this),this.i){var a=this.i,u;for(u in a.g){for(var d=a.g[u],m=0;m<d.length;m++)Cs(d[m]);delete a.g[u],a.h--}}this.F=null},Se.prototype.K=function(a,u,d,m){return this.i.add(String(a),u,!1,d,m)},Se.prototype.L=function(a,u,d,m){return this.i.add(String(a),u,!0,d,m)};function xs(a,u,d,m){if(u=a.i.g[String(u)],!u)return!0;u=u.concat();for(var A=!0,C=0;C<u.length;++C){var F=u[C];if(F&&!F.da&&F.capture==d){var ie=F.listener,we=F.ha||F.src;F.fa&&_o(a.i,F),A=ie.call(we,m)!==!1&&A}}return A&&!m.defaultPrevented}function il(a,u,d){if(typeof a=="function")d&&(a=g(a,d));else if(a&&typeof a.handleEvent=="function")a=g(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(u)?-1:c.setTimeout(a,u||0)}function ol(a){a.g=il(()=>{a.g=null,a.i&&(a.i=!1,ol(a))},a.l);const u=a.h;a.h=null,a.m.apply(null,u)}class zm extends Et{constructor(u,d){super(),this.m=u,this.l=d,this.h=null,this.i=!1,this.g=null}j(u){this.h=arguments,this.g?this.i=!0:ol(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Er(a){Et.call(this),this.h=a,this.g={}}P(Er,Et);var al=[];function cl(a){O(a.g,function(u,d){this.g.hasOwnProperty(d)&&Eo(u)},a),a.g={}}Er.prototype.N=function(){Er.aa.N.call(this),cl(this)},Er.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Ao=c.JSON.stringify,Gm=c.JSON.parse,Hm=class{stringify(a){return c.JSON.stringify(a,void 0)}parse(a){return c.JSON.parse(a,void 0)}};function So(){}So.prototype.h=null;function ll(a){return a.h||(a.h=a.i())}function ul(){}var wr={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function Ro(){Ae.call(this,"d")}P(Ro,Ae);function Po(){Ae.call(this,"c")}P(Po,Ae);var Qt={},hl=null;function Ds(){return hl=hl||new Se}Qt.La="serverreachability";function dl(a){Ae.call(this,Qt.La,a)}P(dl,Ae);function br(a){const u=Ds();Ve(u,new dl(u))}Qt.STAT_EVENT="statevent";function fl(a,u){Ae.call(this,Qt.STAT_EVENT,a),this.stat=u}P(fl,Ae);function Ne(a){const u=Ds();Ve(u,new fl(u,a))}Qt.Ma="timingevent";function pl(a,u){Ae.call(this,Qt.Ma,a),this.size=u}P(pl,Ae);function Ar(a,u){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){a()},u)}function Sr(){this.g=!0}Sr.prototype.xa=function(){this.g=!1};function Km(a,u,d,m,A,C){a.info(function(){if(a.g)if(C)for(var F="",ie=C.split("&"),we=0;we<ie.length;we++){var ee=ie[we].split("=");if(1<ee.length){var Re=ee[0];ee=ee[1];var Pe=Re.split("_");F=2<=Pe.length&&Pe[1]=="type"?F+(Re+"="+ee+"&"):F+(Re+"=redacted&")}}else F=null;else F=C;return"XMLHTTP REQ ("+m+") [attempt "+A+"]: "+u+`
`+d+`
`+F})}function Wm(a,u,d,m,A,C,F){a.info(function(){return"XMLHTTP RESP ("+m+") [ attempt "+A+"]: "+u+`
`+d+`
`+C+" "+F})}function Dn(a,u,d,m){a.info(function(){return"XMLHTTP TEXT ("+u+"): "+Jm(a,d)+(m?" "+m:"")})}function Qm(a,u){a.info(function(){return"TIMEOUT: "+u})}Sr.prototype.info=function(){};function Jm(a,u){if(!a.g)return u;if(!u)return null;try{var d=JSON.parse(u);if(d){for(a=0;a<d.length;a++)if(Array.isArray(d[a])){var m=d[a];if(!(2>m.length)){var A=m[1];if(Array.isArray(A)&&!(1>A.length)){var C=A[0];if(C!="noop"&&C!="stop"&&C!="close")for(var F=1;F<A.length;F++)A[F]=""}}}}return Ao(d)}catch{return u}}var Vs={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},ml={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},Co;function Ns(){}P(Ns,So),Ns.prototype.g=function(){return new XMLHttpRequest},Ns.prototype.i=function(){return{}},Co=new Ns;function wt(a,u,d,m){this.j=a,this.i=u,this.l=d,this.R=m||1,this.U=new Er(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new gl}function gl(){this.i=null,this.g="",this.h=!1}var yl={},ko={};function xo(a,u,d){a.L=1,a.v=js(ut(u)),a.m=d,a.P=!0,_l(a,null)}function _l(a,u){a.F=Date.now(),Ls(a),a.A=ut(a.v);var d=a.A,m=a.R;Array.isArray(m)||(m=[String(m)]),Dl(d.i,"t",m),a.C=0,d=a.j.J,a.h=new gl,a.g=Jl(a.j,d?u:null,!a.m),0<a.O&&(a.M=new zm(g(a.Y,a,a.g),a.O)),u=a.U,d=a.g,m=a.ca;var A="readystatechange";Array.isArray(A)||(A&&(al[0]=A.toString()),A=al);for(var C=0;C<A.length;C++){var F=tl(d,A[C],m||u.handleEvent,!1,u.h||u);if(!F)break;u.g[F.key]=F}u=a.H?y(a.H):{},a.m?(a.u||(a.u="POST"),u["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.A,a.u,a.m,u)):(a.u="GET",a.g.ea(a.A,a.u,null,u)),br(),Km(a.i,a.u,a.A,a.l,a.R,a.m)}wt.prototype.ca=function(a){a=a.target;const u=this.M;u&&ht(a)==3?u.j():this.Y(a)},wt.prototype.Y=function(a){try{if(a==this.g)e:{const Pe=ht(this.g);var u=this.g.Ba();const Ln=this.g.Z();if(!(3>Pe)&&(Pe!=3||this.g&&(this.h.h||this.g.oa()||Fl(this.g)))){this.J||Pe!=4||u==7||(u==8||0>=Ln?br(3):br(2)),Do(this);var d=this.g.Z();this.X=d;t:if(vl(this)){var m=Fl(this.g);a="";var A=m.length,C=ht(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){Jt(this),Rr(this);var F="";break t}this.h.i=new c.TextDecoder}for(u=0;u<A;u++)this.h.h=!0,a+=this.h.i.decode(m[u],{stream:!(C&&u==A-1)});m.length=0,this.h.g+=a,this.C=0,F=this.h.g}else F=this.g.oa();if(this.o=d==200,Wm(this.i,this.u,this.A,this.l,this.R,Pe,d),this.o){if(this.T&&!this.K){t:{if(this.g){var ie,we=this.g;if((ie=we.g?we.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!j(ie)){var ee=ie;break t}}ee=null}if(d=ee)Dn(this.i,this.l,d,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Vo(this,d);else{this.o=!1,this.s=3,Ne(12),Jt(this),Rr(this);break e}}if(this.P){d=!0;let We;for(;!this.J&&this.C<F.length;)if(We=Ym(this,F),We==ko){Pe==4&&(this.s=4,Ne(14),d=!1),Dn(this.i,this.l,null,"[Incomplete Response]");break}else if(We==yl){this.s=4,Ne(15),Dn(this.i,this.l,F,"[Invalid Chunk]"),d=!1;break}else Dn(this.i,this.l,We,null),Vo(this,We);if(vl(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Pe!=4||F.length!=0||this.h.h||(this.s=1,Ne(16),d=!1),this.o=this.o&&d,!d)Dn(this.i,this.l,F,"[Invalid Chunked Response]"),Jt(this),Rr(this);else if(0<F.length&&!this.W){this.W=!0;var Re=this.j;Re.g==this&&Re.ba&&!Re.M&&(Re.j.info("Great, no buffering proxy detected. Bytes received: "+F.length),Fo(Re),Re.M=!0,Ne(11))}}else Dn(this.i,this.l,F,null),Vo(this,F);Pe==4&&Jt(this),this.o&&!this.J&&(Pe==4?Hl(this.j,this):(this.o=!1,Ls(this)))}else pg(this.g),d==400&&0<F.indexOf("Unknown SID")?(this.s=3,Ne(12)):(this.s=0,Ne(13)),Jt(this),Rr(this)}}}catch{}finally{}};function vl(a){return a.g?a.u=="GET"&&a.L!=2&&a.j.Ca:!1}function Ym(a,u){var d=a.C,m=u.indexOf(`
`,d);return m==-1?ko:(d=Number(u.substring(d,m)),isNaN(d)?yl:(m+=1,m+d>u.length?ko:(u=u.slice(m,m+d),a.C=m+d,u)))}wt.prototype.cancel=function(){this.J=!0,Jt(this)};function Ls(a){a.S=Date.now()+a.I,Il(a,a.I)}function Il(a,u){if(a.B!=null)throw Error("WatchDog timer not null");a.B=Ar(g(a.ba,a),u)}function Do(a){a.B&&(c.clearTimeout(a.B),a.B=null)}wt.prototype.ba=function(){this.B=null;const a=Date.now();0<=a-this.S?(Qm(this.i,this.A),this.L!=2&&(br(),Ne(17)),Jt(this),this.s=2,Rr(this)):Il(this,this.S-a)};function Rr(a){a.j.G==0||a.J||Hl(a.j,a)}function Jt(a){Do(a);var u=a.M;u&&typeof u.ma=="function"&&u.ma(),a.M=null,cl(a.U),a.g&&(u=a.g,a.g=null,u.abort(),u.ma())}function Vo(a,u){try{var d=a.j;if(d.G!=0&&(d.g==a||No(d.h,a))){if(!a.K&&No(d.h,a)&&d.G==3){try{var m=d.Da.g.parse(u)}catch{m=null}if(Array.isArray(m)&&m.length==3){var A=m;if(A[0]==0){e:if(!d.u){if(d.g)if(d.g.F+3e3<a.F)zs(d),$s(d);else break e;jo(d),Ne(18)}}else d.za=A[1],0<d.za-d.T&&37500>A[2]&&d.F&&d.v==0&&!d.C&&(d.C=Ar(g(d.Za,d),6e3));if(1>=wl(d.h)&&d.ca){try{d.ca()}catch{}d.ca=void 0}}else Xt(d,11)}else if((a.K||d.g==a)&&zs(d),!j(u))for(A=d.Da.g.parse(u),u=0;u<A.length;u++){let ee=A[u];if(d.T=ee[0],ee=ee[1],d.G==2)if(ee[0]=="c"){d.K=ee[1],d.ia=ee[2];const Re=ee[3];Re!=null&&(d.la=Re,d.j.info("VER="+d.la));const Pe=ee[4];Pe!=null&&(d.Aa=Pe,d.j.info("SVER="+d.Aa));const Ln=ee[5];Ln!=null&&typeof Ln=="number"&&0<Ln&&(m=1.5*Ln,d.L=m,d.j.info("backChannelRequestTimeoutMs_="+m)),m=d;const We=a.g;if(We){const Hs=We.g?We.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Hs){var C=m.h;C.g||Hs.indexOf("spdy")==-1&&Hs.indexOf("quic")==-1&&Hs.indexOf("h2")==-1||(C.j=C.l,C.g=new Set,C.h&&(Lo(C,C.h),C.h=null))}if(m.D){const Bo=We.g?We.g.getResponseHeader("X-HTTP-Session-Id"):null;Bo&&(m.ya=Bo,ce(m.I,m.D,Bo))}}d.G=3,d.l&&d.l.ua(),d.ba&&(d.R=Date.now()-a.F,d.j.info("Handshake RTT: "+d.R+"ms")),m=d;var F=a;if(m.qa=Ql(m,m.J?m.ia:null,m.W),F.K){bl(m.h,F);var ie=F,we=m.L;we&&(ie.I=we),ie.B&&(Do(ie),Ls(ie)),m.g=F}else zl(m);0<d.i.length&&qs(d)}else ee[0]!="stop"&&ee[0]!="close"||Xt(d,7);else d.G==3&&(ee[0]=="stop"||ee[0]=="close"?ee[0]=="stop"?Xt(d,7):Mo(d):ee[0]!="noop"&&d.l&&d.l.ta(ee),d.v=0)}}br(4)}catch{}}var Xm=class{constructor(a,u){this.g=a,this.map=u}};function Tl(a){this.l=a||10,c.PerformanceNavigationTiming?(a=c.performance.getEntriesByType("navigation"),a=0<a.length&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function El(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function wl(a){return a.h?1:a.g?a.g.size:0}function No(a,u){return a.h?a.h==u:a.g?a.g.has(u):!1}function Lo(a,u){a.g?a.g.add(u):a.h=u}function bl(a,u){a.h&&a.h==u?a.h=null:a.g&&a.g.has(u)&&a.g.delete(u)}Tl.prototype.cancel=function(){if(this.i=Al(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function Al(a){if(a.h!=null)return a.i.concat(a.h.D);if(a.g!=null&&a.g.size!==0){let u=a.i;for(const d of a.g.values())u=u.concat(d.D);return u}return D(a.i)}function Zm(a){if(a.V&&typeof a.V=="function")return a.V();if(typeof Map<"u"&&a instanceof Map||typeof Set<"u"&&a instanceof Set)return Array.from(a.values());if(typeof a=="string")return a.split("");if(l(a)){for(var u=[],d=a.length,m=0;m<d;m++)u.push(a[m]);return u}u=[],d=0;for(m in a)u[d++]=a[m];return u}function eg(a){if(a.na&&typeof a.na=="function")return a.na();if(!a.V||typeof a.V!="function"){if(typeof Map<"u"&&a instanceof Map)return Array.from(a.keys());if(!(typeof Set<"u"&&a instanceof Set)){if(l(a)||typeof a=="string"){var u=[];a=a.length;for(var d=0;d<a;d++)u.push(d);return u}u=[],d=0;for(const m in a)u[d++]=m;return u}}}function Sl(a,u){if(a.forEach&&typeof a.forEach=="function")a.forEach(u,void 0);else if(l(a)||typeof a=="string")Array.prototype.forEach.call(a,u,void 0);else for(var d=eg(a),m=Zm(a),A=m.length,C=0;C<A;C++)u.call(void 0,m[C],d&&d[C],a)}var Rl=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function tg(a,u){if(a){a=a.split("&");for(var d=0;d<a.length;d++){var m=a[d].indexOf("="),A=null;if(0<=m){var C=a[d].substring(0,m);A=a[d].substring(m+1)}else C=a[d];u(C,A?decodeURIComponent(A.replace(/\+/g," ")):"")}}}function Yt(a){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,a instanceof Yt){this.h=a.h,Os(this,a.j),this.o=a.o,this.g=a.g,Ms(this,a.s),this.l=a.l;var u=a.i,d=new kr;d.i=u.i,u.g&&(d.g=new Map(u.g),d.h=u.h),Pl(this,d),this.m=a.m}else a&&(u=String(a).match(Rl))?(this.h=!1,Os(this,u[1]||"",!0),this.o=Pr(u[2]||""),this.g=Pr(u[3]||"",!0),Ms(this,u[4]),this.l=Pr(u[5]||"",!0),Pl(this,u[6]||"",!0),this.m=Pr(u[7]||"")):(this.h=!1,this.i=new kr(null,this.h))}Yt.prototype.toString=function(){var a=[],u=this.j;u&&a.push(Cr(u,Cl,!0),":");var d=this.g;return(d||u=="file")&&(a.push("//"),(u=this.o)&&a.push(Cr(u,Cl,!0),"@"),a.push(encodeURIComponent(String(d)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),d=this.s,d!=null&&a.push(":",String(d))),(d=this.l)&&(this.g&&d.charAt(0)!="/"&&a.push("/"),a.push(Cr(d,d.charAt(0)=="/"?sg:rg,!0))),(d=this.i.toString())&&a.push("?",d),(d=this.m)&&a.push("#",Cr(d,og)),a.join("")};function ut(a){return new Yt(a)}function Os(a,u,d){a.j=d?Pr(u,!0):u,a.j&&(a.j=a.j.replace(/:$/,""))}function Ms(a,u){if(u){if(u=Number(u),isNaN(u)||0>u)throw Error("Bad port number "+u);a.s=u}else a.s=null}function Pl(a,u,d){u instanceof kr?(a.i=u,ag(a.i,a.h)):(d||(u=Cr(u,ig)),a.i=new kr(u,a.h))}function ce(a,u,d){a.i.set(u,d)}function js(a){return ce(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),a}function Pr(a,u){return a?u?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function Cr(a,u,d){return typeof a=="string"?(a=encodeURI(a).replace(u,ng),d&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function ng(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var Cl=/[#\/\?@]/g,rg=/[#\?:]/g,sg=/[#\?]/g,ig=/[#\?@]/g,og=/#/g;function kr(a,u){this.h=this.g=null,this.i=a||null,this.j=!!u}function bt(a){a.g||(a.g=new Map,a.h=0,a.i&&tg(a.i,function(u,d){a.add(decodeURIComponent(u.replace(/\+/g," ")),d)}))}r=kr.prototype,r.add=function(a,u){bt(this),this.i=null,a=Vn(this,a);var d=this.g.get(a);return d||this.g.set(a,d=[]),d.push(u),this.h+=1,this};function kl(a,u){bt(a),u=Vn(a,u),a.g.has(u)&&(a.i=null,a.h-=a.g.get(u).length,a.g.delete(u))}function xl(a,u){return bt(a),u=Vn(a,u),a.g.has(u)}r.forEach=function(a,u){bt(this),this.g.forEach(function(d,m){d.forEach(function(A){a.call(u,A,m,this)},this)},this)},r.na=function(){bt(this);const a=Array.from(this.g.values()),u=Array.from(this.g.keys()),d=[];for(let m=0;m<u.length;m++){const A=a[m];for(let C=0;C<A.length;C++)d.push(u[m])}return d},r.V=function(a){bt(this);let u=[];if(typeof a=="string")xl(this,a)&&(u=u.concat(this.g.get(Vn(this,a))));else{a=Array.from(this.g.values());for(let d=0;d<a.length;d++)u=u.concat(a[d])}return u},r.set=function(a,u){return bt(this),this.i=null,a=Vn(this,a),xl(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[u]),this.h+=1,this},r.get=function(a,u){return a?(a=this.V(a),0<a.length?String(a[0]):u):u};function Dl(a,u,d){kl(a,u),0<d.length&&(a.i=null,a.g.set(Vn(a,u),D(d)),a.h+=d.length)}r.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],u=Array.from(this.g.keys());for(var d=0;d<u.length;d++){var m=u[d];const C=encodeURIComponent(String(m)),F=this.V(m);for(m=0;m<F.length;m++){var A=C;F[m]!==""&&(A+="="+encodeURIComponent(String(F[m]))),a.push(A)}}return this.i=a.join("&")};function Vn(a,u){return u=String(u),a.j&&(u=u.toLowerCase()),u}function ag(a,u){u&&!a.j&&(bt(a),a.i=null,a.g.forEach(function(d,m){var A=m.toLowerCase();m!=A&&(kl(this,m),Dl(this,A,d))},a)),a.j=u}function cg(a,u){const d=new Sr;if(c.Image){const m=new Image;m.onload=E(At,d,"TestLoadImage: loaded",!0,u,m),m.onerror=E(At,d,"TestLoadImage: error",!1,u,m),m.onabort=E(At,d,"TestLoadImage: abort",!1,u,m),m.ontimeout=E(At,d,"TestLoadImage: timeout",!1,u,m),c.setTimeout(function(){m.ontimeout&&m.ontimeout()},1e4),m.src=a}else u(!1)}function lg(a,u){const d=new Sr,m=new AbortController,A=setTimeout(()=>{m.abort(),At(d,"TestPingServer: timeout",!1,u)},1e4);fetch(a,{signal:m.signal}).then(C=>{clearTimeout(A),C.ok?At(d,"TestPingServer: ok",!0,u):At(d,"TestPingServer: server error",!1,u)}).catch(()=>{clearTimeout(A),At(d,"TestPingServer: error",!1,u)})}function At(a,u,d,m,A){try{A&&(A.onload=null,A.onerror=null,A.onabort=null,A.ontimeout=null),m(d)}catch{}}function ug(){this.g=new Hm}function hg(a,u,d){const m=d||"";try{Sl(a,function(A,C){let F=A;h(A)&&(F=Ao(A)),u.push(m+C+"="+encodeURIComponent(F))})}catch(A){throw u.push(m+"type="+encodeURIComponent("_badmap")),A}}function Fs(a){this.l=a.Ub||null,this.j=a.eb||!1}P(Fs,So),Fs.prototype.g=function(){return new Bs(this.l,this.j)},Fs.prototype.i=function(a){return function(){return a}}({});function Bs(a,u){Se.call(this),this.D=a,this.o=u,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}P(Bs,Se),r=Bs.prototype,r.open=function(a,u){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=a,this.A=u,this.readyState=1,Dr(this)},r.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const u={headers:this.u,method:this.B,credentials:this.m,cache:void 0};a&&(u.body=a),(this.D||c).fetch(new Request(this.A,u)).then(this.Sa.bind(this),this.ga.bind(this))},r.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,xr(this)),this.readyState=0},r.Sa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,Dr(this)),this.g&&(this.readyState=3,Dr(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Vl(this)}else a.text().then(this.Ra.bind(this),this.ga.bind(this))};function Vl(a){a.j.read().then(a.Pa.bind(a)).catch(a.ga.bind(a))}r.Pa=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var u=a.value?a.value:new Uint8Array(0);(u=this.v.decode(u,{stream:!a.done}))&&(this.response=this.responseText+=u)}a.done?xr(this):Dr(this),this.readyState==3&&Vl(this)}},r.Ra=function(a){this.g&&(this.response=this.responseText=a,xr(this))},r.Qa=function(a){this.g&&(this.response=a,xr(this))},r.ga=function(){this.g&&xr(this)};function xr(a){a.readyState=4,a.l=null,a.j=null,a.v=null,Dr(a)}r.setRequestHeader=function(a,u){this.u.append(a,u)},r.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},r.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],u=this.h.entries();for(var d=u.next();!d.done;)d=d.value,a.push(d[0]+": "+d[1]),d=u.next();return a.join(`\r
`)};function Dr(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(Bs.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function Nl(a){let u="";return O(a,function(d,m){u+=m,u+=":",u+=d,u+=`\r
`}),u}function Oo(a,u,d){e:{for(m in d){var m=!1;break e}m=!0}m||(d=Nl(d),typeof a=="string"?d!=null&&encodeURIComponent(String(d)):ce(a,u,d))}function de(a){Se.call(this),this.headers=new Map,this.o=a||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}P(de,Se);var dg=/^https?$/i,fg=["POST","PUT"];r=de.prototype,r.Ha=function(a){this.J=a},r.ea=function(a,u,d,m){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);u=u?u.toUpperCase():"GET",this.D=a,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():Co.g(),this.v=this.o?ll(this.o):ll(Co),this.g.onreadystatechange=g(this.Ea,this);try{this.B=!0,this.g.open(u,String(a),!0),this.B=!1}catch(C){Ll(this,C);return}if(a=d||"",d=new Map(this.headers),m)if(Object.getPrototypeOf(m)===Object.prototype)for(var A in m)d.set(A,m[A]);else if(typeof m.keys=="function"&&typeof m.get=="function")for(const C of m.keys())d.set(C,m.get(C));else throw Error("Unknown input type for opt_headers: "+String(m));m=Array.from(d.keys()).find(C=>C.toLowerCase()=="content-type"),A=c.FormData&&a instanceof c.FormData,!(0<=Array.prototype.indexOf.call(fg,u,void 0))||m||A||d.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[C,F]of d)this.g.setRequestHeader(C,F);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{jl(this),this.u=!0,this.g.send(a),this.u=!1}catch(C){Ll(this,C)}};function Ll(a,u){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=u,a.m=5,Ol(a),Us(a)}function Ol(a){a.A||(a.A=!0,Ve(a,"complete"),Ve(a,"error"))}r.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=a||7,Ve(this,"complete"),Ve(this,"abort"),Us(this))},r.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Us(this,!0)),de.aa.N.call(this)},r.Ea=function(){this.s||(this.B||this.u||this.j?Ml(this):this.bb())},r.bb=function(){Ml(this)};function Ml(a){if(a.h&&typeof o<"u"&&(!a.v[1]||ht(a)!=4||a.Z()!=2)){if(a.u&&ht(a)==4)il(a.Ea,0,a);else if(Ve(a,"readystatechange"),ht(a)==4){a.h=!1;try{const F=a.Z();e:switch(F){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var u=!0;break e;default:u=!1}var d;if(!(d=u)){var m;if(m=F===0){var A=String(a.D).match(Rl)[1]||null;!A&&c.self&&c.self.location&&(A=c.self.location.protocol.slice(0,-1)),m=!dg.test(A?A.toLowerCase():"")}d=m}if(d)Ve(a,"complete"),Ve(a,"success");else{a.m=6;try{var C=2<ht(a)?a.g.statusText:""}catch{C=""}a.l=C+" ["+a.Z()+"]",Ol(a)}}finally{Us(a)}}}}function Us(a,u){if(a.g){jl(a);const d=a.g,m=a.v[0]?()=>{}:null;a.g=null,a.v=null,u||Ve(a,"ready");try{d.onreadystatechange=m}catch{}}}function jl(a){a.I&&(c.clearTimeout(a.I),a.I=null)}r.isActive=function(){return!!this.g};function ht(a){return a.g?a.g.readyState:0}r.Z=function(){try{return 2<ht(this)?this.g.status:-1}catch{return-1}},r.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},r.Oa=function(a){if(this.g){var u=this.g.responseText;return a&&u.indexOf(a)==0&&(u=u.substring(a.length)),Gm(u)}};function Fl(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.H){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function pg(a){const u={};a=(a.g&&2<=ht(a)&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let m=0;m<a.length;m++){if(j(a[m]))continue;var d=b(a[m]);const A=d[0];if(d=d[1],typeof d!="string")continue;d=d.trim();const C=u[A]||[];u[A]=C,C.push(d)}I(u,function(m){return m.join(", ")})}r.Ba=function(){return this.m},r.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function Vr(a,u,d){return d&&d.internalChannelParams&&d.internalChannelParams[a]||u}function Bl(a){this.Aa=0,this.i=[],this.j=new Sr,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=Vr("failFast",!1,a),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=Vr("baseRetryDelayMs",5e3,a),this.cb=Vr("retryDelaySeedMs",1e4,a),this.Wa=Vr("forwardChannelMaxRetries",2,a),this.wa=Vr("forwardChannelRequestTimeoutMs",2e4,a),this.pa=a&&a.xmlHttpFactory||void 0,this.Xa=a&&a.Tb||void 0,this.Ca=a&&a.useFetchStreams||!1,this.L=void 0,this.J=a&&a.supportsCrossDomainXhr||!1,this.K="",this.h=new Tl(a&&a.concurrentRequestLimit),this.Da=new ug,this.P=a&&a.fastHandshake||!1,this.O=a&&a.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=a&&a.Rb||!1,a&&a.xa&&this.j.xa(),a&&a.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&a&&a.detectBufferingProxy||!1,this.ja=void 0,a&&a.longPollingTimeout&&0<a.longPollingTimeout&&(this.ja=a.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}r=Bl.prototype,r.la=8,r.G=1,r.connect=function(a,u,d,m){Ne(0),this.W=a,this.H=u||{},d&&m!==void 0&&(this.H.OSID=d,this.H.OAID=m),this.F=this.X,this.I=Ql(this,null,this.W),qs(this)};function Mo(a){if(Ul(a),a.G==3){var u=a.U++,d=ut(a.I);if(ce(d,"SID",a.K),ce(d,"RID",u),ce(d,"TYPE","terminate"),Nr(a,d),u=new wt(a,a.j,u),u.L=2,u.v=js(ut(d)),d=!1,c.navigator&&c.navigator.sendBeacon)try{d=c.navigator.sendBeacon(u.v.toString(),"")}catch{}!d&&c.Image&&(new Image().src=u.v,d=!0),d||(u.g=Jl(u.j,null),u.g.ea(u.v)),u.F=Date.now(),Ls(u)}Wl(a)}function $s(a){a.g&&(Fo(a),a.g.cancel(),a.g=null)}function Ul(a){$s(a),a.u&&(c.clearTimeout(a.u),a.u=null),zs(a),a.h.cancel(),a.s&&(typeof a.s=="number"&&c.clearTimeout(a.s),a.s=null)}function qs(a){if(!El(a.h)&&!a.s){a.s=!0;var u=a.Ga;vr||el(),Ir||(vr(),Ir=!0),yo.add(u,a),a.B=0}}function mg(a,u){return wl(a.h)>=a.h.j-(a.s?1:0)?!1:a.s?(a.i=u.D.concat(a.i),!0):a.G==1||a.G==2||a.B>=(a.Va?0:a.Wa)?!1:(a.s=Ar(g(a.Ga,a,u),Kl(a,a.B)),a.B++,!0)}r.Ga=function(a){if(this.s)if(this.s=null,this.G==1){if(!a){this.U=Math.floor(1e5*Math.random()),a=this.U++;const A=new wt(this,this.j,a);let C=this.o;if(this.S&&(C?(C=y(C),w(C,this.S)):C=this.S),this.m!==null||this.O||(A.H=C,C=null),this.P)e:{for(var u=0,d=0;d<this.i.length;d++){t:{var m=this.i[d];if("__data__"in m.map&&(m=m.map.__data__,typeof m=="string")){m=m.length;break t}m=void 0}if(m===void 0)break;if(u+=m,4096<u){u=d;break e}if(u===4096||d===this.i.length-1){u=d+1;break e}}u=1e3}else u=1e3;u=ql(this,A,u),d=ut(this.I),ce(d,"RID",a),ce(d,"CVER",22),this.D&&ce(d,"X-HTTP-Session-Id",this.D),Nr(this,d),C&&(this.O?u="headers="+encodeURIComponent(String(Nl(C)))+"&"+u:this.m&&Oo(d,this.m,C)),Lo(this.h,A),this.Ua&&ce(d,"TYPE","init"),this.P?(ce(d,"$req",u),ce(d,"SID","null"),A.T=!0,xo(A,d,null)):xo(A,d,u),this.G=2}}else this.G==3&&(a?$l(this,a):this.i.length==0||El(this.h)||$l(this))};function $l(a,u){var d;u?d=u.l:d=a.U++;const m=ut(a.I);ce(m,"SID",a.K),ce(m,"RID",d),ce(m,"AID",a.T),Nr(a,m),a.m&&a.o&&Oo(m,a.m,a.o),d=new wt(a,a.j,d,a.B+1),a.m===null&&(d.H=a.o),u&&(a.i=u.D.concat(a.i)),u=ql(a,d,1e3),d.I=Math.round(.5*a.wa)+Math.round(.5*a.wa*Math.random()),Lo(a.h,d),xo(d,m,u)}function Nr(a,u){a.H&&O(a.H,function(d,m){ce(u,m,d)}),a.l&&Sl({},function(d,m){ce(u,m,d)})}function ql(a,u,d){d=Math.min(a.i.length,d);var m=a.l?g(a.l.Na,a.l,a):null;e:{var A=a.i;let C=-1;for(;;){const F=["count="+d];C==-1?0<d?(C=A[0].g,F.push("ofs="+C)):C=0:F.push("ofs="+C);let ie=!0;for(let we=0;we<d;we++){let ee=A[we].g;const Re=A[we].map;if(ee-=C,0>ee)C=Math.max(0,A[we].g-100),ie=!1;else try{hg(Re,F,"req"+ee+"_")}catch{m&&m(Re)}}if(ie){m=F.join("&");break e}}}return a=a.i.splice(0,d),u.D=a,m}function zl(a){if(!a.g&&!a.u){a.Y=1;var u=a.Fa;vr||el(),Ir||(vr(),Ir=!0),yo.add(u,a),a.v=0}}function jo(a){return a.g||a.u||3<=a.v?!1:(a.Y++,a.u=Ar(g(a.Fa,a),Kl(a,a.v)),a.v++,!0)}r.Fa=function(){if(this.u=null,Gl(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var a=2*this.R;this.j.info("BP detection timer enabled: "+a),this.A=Ar(g(this.ab,this),a)}},r.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,Ne(10),$s(this),Gl(this))};function Fo(a){a.A!=null&&(c.clearTimeout(a.A),a.A=null)}function Gl(a){a.g=new wt(a,a.j,"rpc",a.Y),a.m===null&&(a.g.H=a.o),a.g.O=0;var u=ut(a.qa);ce(u,"RID","rpc"),ce(u,"SID",a.K),ce(u,"AID",a.T),ce(u,"CI",a.F?"0":"1"),!a.F&&a.ja&&ce(u,"TO",a.ja),ce(u,"TYPE","xmlhttp"),Nr(a,u),a.m&&a.o&&Oo(u,a.m,a.o),a.L&&(a.g.I=a.L);var d=a.g;a=a.ia,d.L=1,d.v=js(ut(u)),d.m=null,d.P=!0,_l(d,a)}r.Za=function(){this.C!=null&&(this.C=null,$s(this),jo(this),Ne(19))};function zs(a){a.C!=null&&(c.clearTimeout(a.C),a.C=null)}function Hl(a,u){var d=null;if(a.g==u){zs(a),Fo(a),a.g=null;var m=2}else if(No(a.h,u))d=u.D,bl(a.h,u),m=1;else return;if(a.G!=0){if(u.o)if(m==1){d=u.m?u.m.length:0,u=Date.now()-u.F;var A=a.B;m=Ds(),Ve(m,new pl(m,d)),qs(a)}else zl(a);else if(A=u.s,A==3||A==0&&0<u.X||!(m==1&&mg(a,u)||m==2&&jo(a)))switch(d&&0<d.length&&(u=a.h,u.i=u.i.concat(d)),A){case 1:Xt(a,5);break;case 4:Xt(a,10);break;case 3:Xt(a,6);break;default:Xt(a,2)}}}function Kl(a,u){let d=a.Ta+Math.floor(Math.random()*a.cb);return a.isActive()||(d*=2),d*u}function Xt(a,u){if(a.j.info("Error code "+u),u==2){var d=g(a.fb,a),m=a.Xa;const A=!m;m=new Yt(m||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||Os(m,"https"),js(m),A?cg(m.toString(),d):lg(m.toString(),d)}else Ne(2);a.G=0,a.l&&a.l.sa(u),Wl(a),Ul(a)}r.fb=function(a){a?(this.j.info("Successfully pinged google.com"),Ne(2)):(this.j.info("Failed to ping google.com"),Ne(1))};function Wl(a){if(a.G=0,a.ka=[],a.l){const u=Al(a.h);(u.length!=0||a.i.length!=0)&&(k(a.ka,u),k(a.ka,a.i),a.h.i.length=0,D(a.i),a.i.length=0),a.l.ra()}}function Ql(a,u,d){var m=d instanceof Yt?ut(d):new Yt(d);if(m.g!="")u&&(m.g=u+"."+m.g),Ms(m,m.s);else{var A=c.location;m=A.protocol,u=u?u+"."+A.hostname:A.hostname,A=+A.port;var C=new Yt(null);m&&Os(C,m),u&&(C.g=u),A&&Ms(C,A),d&&(C.l=d),m=C}return d=a.D,u=a.ya,d&&u&&ce(m,d,u),ce(m,"VER",a.la),Nr(a,m),m}function Jl(a,u,d){if(u&&!a.J)throw Error("Can't create secondary domain capable XhrIo object.");return u=a.Ca&&!a.pa?new de(new Fs({eb:d})):new de(a.pa),u.Ha(a.J),u}r.isActive=function(){return!!this.l&&this.l.isActive(this)};function Yl(){}r=Yl.prototype,r.ua=function(){},r.ta=function(){},r.sa=function(){},r.ra=function(){},r.isActive=function(){return!0},r.Na=function(){};function Gs(){}Gs.prototype.g=function(a,u){return new $e(a,u)};function $e(a,u){Se.call(this),this.g=new Bl(u),this.l=a,this.h=u&&u.messageUrlParams||null,a=u&&u.messageHeaders||null,u&&u.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=u&&u.initMessageHeaders||null,u&&u.messageContentType&&(a?a["X-WebChannel-Content-Type"]=u.messageContentType:a={"X-WebChannel-Content-Type":u.messageContentType}),u&&u.va&&(a?a["X-WebChannel-Client-Profile"]=u.va:a={"X-WebChannel-Client-Profile":u.va}),this.g.S=a,(a=u&&u.Sb)&&!j(a)&&(this.g.m=a),this.v=u&&u.supportsCrossDomainXhr||!1,this.u=u&&u.sendRawJson||!1,(u=u&&u.httpSessionIdParam)&&!j(u)&&(this.g.D=u,a=this.h,a!==null&&u in a&&(a=this.h,u in a&&delete a[u])),this.j=new Nn(this)}P($e,Se),$e.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},$e.prototype.close=function(){Mo(this.g)},$e.prototype.o=function(a){var u=this.g;if(typeof a=="string"){var d={};d.__data__=a,a=d}else this.u&&(d={},d.__data__=Ao(a),a=d);u.i.push(new Xm(u.Ya++,a)),u.G==3&&qs(u)},$e.prototype.N=function(){this.g.l=null,delete this.j,Mo(this.g),delete this.g,$e.aa.N.call(this)};function Xl(a){Ro.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var u=a.__sm__;if(u){e:{for(const d in u){a=d;break e}a=void 0}(this.i=a)&&(a=this.i,u=u!==null&&a in u?u[a]:void 0),this.data=u}else this.data=a}P(Xl,Ro);function Zl(){Po.call(this),this.status=1}P(Zl,Po);function Nn(a){this.g=a}P(Nn,Yl),Nn.prototype.ua=function(){Ve(this.g,"a")},Nn.prototype.ta=function(a){Ve(this.g,new Xl(a))},Nn.prototype.sa=function(a){Ve(this.g,new Zl)},Nn.prototype.ra=function(){Ve(this.g,"b")},Gs.prototype.createWebChannel=Gs.prototype.g,$e.prototype.send=$e.prototype.o,$e.prototype.open=$e.prototype.m,$e.prototype.close=$e.prototype.close,Td=function(){return new Gs},Id=function(){return Ds()},vd=Qt,fa={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Vs.NO_ERROR=0,Vs.TIMEOUT=8,Vs.HTTP_ERROR=6,si=Vs,ml.COMPLETE="complete",_d=ml,ul.EventType=wr,wr.OPEN="a",wr.CLOSE="b",wr.ERROR="c",wr.MESSAGE="d",Se.prototype.listen=Se.prototype.K,$r=ul,de.prototype.listenOnce=de.prototype.L,de.prototype.getLastError=de.prototype.Ka,de.prototype.getLastErrorCode=de.prototype.Ba,de.prototype.getStatus=de.prototype.Z,de.prototype.getResponseJson=de.prototype.Oa,de.prototype.getResponseText=de.prototype.oa,de.prototype.send=de.prototype.ea,de.prototype.setWithCredentials=de.prototype.Ha,yd=de}).apply(typeof Ks<"u"?Ks:typeof self<"u"?self:typeof window<"u"?window:{});const du="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mn=new za("@firebase/firestore");function Un(){return mn.logLevel}function N(r,...e){if(mn.logLevel<=Y.DEBUG){const t=e.map(Ha);mn.debug(`Firestore (${dr}): ${r}`,...t)}}function ye(r,...e){if(mn.logLevel<=Y.ERROR){const t=e.map(Ha);mn.error(`Firestore (${dr}): ${r}`,...t)}}function ss(r,...e){if(mn.logLevel<=Y.WARN){const t=e.map(Ha);mn.warn(`Firestore (${dr}): ${r}`,...t)}}function Ha(r){if(typeof r=="string")return r;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gt(r){if(r.code!==x.FAILED_PRECONDITION||r.message!==Sd)throw r;N("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ma extends Rd{constructor(e,t){super(),this._e=e,this.currentSequenceNumber=t}}function Te(r,e){const t=z(r);return Ft.F(t._e,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xe{constructor(e){this.value=e}static empty(){return new xe({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let n=0;n<e.length-1;++n)if(t=(t.mapValue.fields||{})[e.get(n)],!ci(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Qr(t)}setAll(e){let t=ue.emptyPath(),n={},s=[];e.forEach((o,c)=>{if(!t.isImmediateParentOf(c)){const l=this.getFieldsMap(t);this.applyChanges(l,n,s),n={},s=[],t=c.popLast()}o?n[c.lastSegment()]=Qr(o):s.push(c.lastSegment())});const i=this.getFieldsMap(t);this.applyChanges(i,n,s)}delete(e){const t=this.field(e.popLast());ci(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return st(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let n=0;n<e.length;++n){let s=t.mapValue.fields[e.get(n)];ci(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(n)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,n){An(t,(s,i)=>e[s]=i);for(const s of n)delete e[s]}clone(){return new xe(Qr(this.value))}}function jd(r){const e=[];return An(r.fields,(t,n)=>{const s=new ue([t]);if(ci(n)){const i=jd(n.mapValue).fields;if(i.length===0)e.push(s);else for(const o of i)e.push(s.child(o))}else e.push(s)}),new Ue(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class U_{constructor(e,t=null,n=[],s=[],i=null,o=null,c=null){this.path=e,this.collectionGroup=t,this.orderBy=n,this.filters=s,this.limit=i,this.startAt=o,this.endAt=c,this.ue=null}}function Ia(r,e=null,t=[],n=[],s=null,i=null,o=null){return new U_(r,e,t,n,s,i,o)}function _n(r){const e=z(r);if(e.ue===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map(n=>va(n)).join(","),t+="|ob:",t+=e.orderBy.map(n=>function(i){return i.field.canonicalString()+i.dir}(n)).join(","),$i(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(n=>Zn(n)).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(n=>Zn(n)).join(",")),e.ue=t}return e.ue}function vs(r,e){if(r.limit!==e.limit||r.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<r.orderBy.length;t++)if(!N_(r.orderBy[t],e.orderBy[t]))return!1;if(r.filters.length!==e.filters.length)return!1;for(let t=0;t<r.filters.length;t++)if(!Ud(r.filters[t],e.filters[t]))return!1;return r.collectionGroup===e.collectionGroup&&!!r.path.isEqual(e.path)&&!!Au(r.startAt,e.startAt)&&Au(r.endAt,e.endAt)}function Ei(r){return U.isDocumentKey(r.path)&&r.collectionGroup===null&&r.filters.length===0}function wi(r,e){return r.filters.filter(t=>t instanceof X&&t.field.isEqual(e))}function Su(r,e,t){let n=ai,s=!0;for(const i of wi(r,e)){let o=ai,c=!0;switch(i.op){case"<":case"<=":o=D_(i.value);break;case"==":case"in":case">=":o=i.value;break;case">":o=i.value,c=!1;break;case"!=":case"not-in":o=ai}Eu({value:n,inclusive:s},{value:o,inclusive:c})<0&&(n=o,s=c)}if(t!==null){for(let i=0;i<r.orderBy.length;++i)if(r.orderBy[i].field.isEqual(e)){const o=t.position[i];Eu({value:n,inclusive:s},{value:o,inclusive:t.inclusive})<0&&(n=o,s=t.inclusive);break}}return{value:n,inclusive:s}}function Ru(r,e,t){let n=Lt,s=!0;for(const i of wi(r,e)){let o=Lt,c=!0;switch(i.op){case">=":case">":o=V_(i.value),c=!1;break;case"==":case"in":case"<=":o=i.value;break;case"<":o=i.value,c=!1;break;case"!=":case"not-in":o=Lt}wu({value:n,inclusive:s},{value:o,inclusive:c})>0&&(n=o,s=c)}if(t!==null){for(let i=0;i<r.orderBy.length;++i)if(r.orderBy[i].field.isEqual(e)){const o=t.position[i];wu({value:n,inclusive:s},{value:o,inclusive:t.inclusive})>0&&(n=o,s=t.inclusive);break}}return{value:n,inclusive:s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ec(r,e){if(r.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:as(e)?"-0":e}}function ef(r){return{integerValue:""+r}}function W_(r,e){return Cd(e)?ef(e):ec(r,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hi{constructor(){this._=void 0}}function Q_(r,e,t){return r instanceof nr?function(s,i){const o={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Ja(i)&&(i=Ya(i)),i&&(o.fields.__previous_value__=i),{mapValue:o}}(t,e):r instanceof rr?nf(r,e):r instanceof sr?rf(r,e):function(s,i){const o=tf(s,i),c=Cu(o)+Cu(s.Pe);return ya(o)&&ya(s.Pe)?ef(c):ec(s.serializer,c)}(r,e)}function J_(r,e,t){return r instanceof rr?nf(r,e):r instanceof sr?rf(r,e):t}function tf(r,e){return r instanceof fs?function(n){return ya(n)||function(i){return!!i&&"doubleValue"in i}(n)}(e)?e:{integerValue:0}:null}class nr extends Hi{}class rr extends Hi{constructor(e){super(),this.elements=e}}function nf(r,e){const t=sf(e);for(const n of r.elements)t.some(s=>st(s,n))||t.push(n);return{arrayValue:{values:t}}}class sr extends Hi{constructor(e){super(),this.elements=e}}function rf(r,e){let t=sf(e);for(const n of r.elements)t=t.filter(s=>!st(s,n));return{arrayValue:{values:t}}}class fs extends Hi{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function Cu(r){return le(r.integerValue||r.doubleValue)}function sf(r){return hs(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qi{constructor(e,t){this.serializer=e,this.userId=t}static lt(e,t){const n=t.uid||"";return new Qi(e,n)}getOverlay(e,t){return Lr(e).get(Bu(this.userId,t)).next(n=>n?Ho(this.serializer,n):null)}getOverlays(e,t){const n=Ze();return R.forEach(t,s=>this.getOverlay(e,s).next(i=>{i!==null&&n.set(s,i)})).next(()=>n)}saveOverlays(e,t,n){const s=[];return n.forEach((i,o)=>{const c=new rc(t,o);s.push(this.ht(e,c))}),R.waitFor(s)}removeOverlaysForBatchId(e,t,n){const s=new Set;t.forEach(o=>s.add(Oe(o.getCollectionPath())));const i=[];return s.forEach(o=>{const c=IDBKeyRange.bound([this.userId,o,n],[this.userId,o,n+1],!1,!0);i.push(Lr(e).j("collectionPathOverlayIndex",c))}),R.waitFor(i)}getOverlaysForCollection(e,t,n){const s=Ze(),i=Oe(t),o=IDBKeyRange.bound([this.userId,i,n],[this.userId,i,Number.POSITIVE_INFINITY],!0);return Lr(e).U("collectionPathOverlayIndex",o).next(c=>{for(const l of c){const h=Ho(this.serializer,l);s.set(h.getKey(),h)}return s})}getOverlaysForCollectionGroup(e,t,n,s){const i=Ze();let o;const c=IDBKeyRange.bound([this.userId,t,n],[this.userId,t,Number.POSITIVE_INFINITY],!0);return Lr(e).J({index:"collectionGroupOverlayIndex",range:c},(l,h,f)=>{const p=Ho(this.serializer,h);i.size()<s||p.largestBatchId===o?(i.set(p.getKey(),p),o=p.largestBatchId):f.done()}).next(()=>i)}ht(e,t){return Lr(e).put(function(s,i,o){const[c,l,h]=Bu(i,o.mutation.key);return{userId:i,collectionPath:l,documentId:h,collectionGroup:o.mutation.key.getCollectionGroup(),largestBatchId:o.largestBatchId,overlayMutation:Ai(s.ct,o.mutation)}}(this.serializer,this.userId,t))}}function Lr(r){return Te(r,"documentOverlays")}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lf{constructor(e,t){this.qr={},this.overlays={},this.Qr=new Be(0),this.Kr=!1,this.Kr=!0,this.$r=new Bv,this.referenceDelegate=e(this),this.Ur=new zv(this),this.indexManager=new Rv,this.remoteDocumentCache=function(s){return new $v(s)}(n=>this.referenceDelegate.Wr(n)),this.serializer=new bf(t),this.Gr=new jv(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new Fv,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let n=this.qr[e.toKey()];return n||(n=new Uv(t,this.referenceDelegate),this.qr[e.toKey()]=n),n}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(e,t,n){N("MemoryPersistence","Starting transaction:",e);const s=new Gv(this.Qr.next());return this.referenceDelegate.zr(),n(s).next(i=>this.referenceDelegate.jr(s).next(()=>i)).toPromise().then(i=>(s.raiseOnCommittedEvent(),i))}Hr(e,t){return R.or(Object.values(this.qr).map(n=>()=>n.containsKey(e,t)))}}class Gv extends Rd{constructor(e){super(),this.currentSequenceNumber=e}}class Yi{constructor(e){this.persistence=e,this.Jr=new cc,this.Yr=null}static Zr(e){return new Yi(e)}get Xr(){if(this.Yr)return this.Yr;throw q()}addReference(e,t,n){return this.Jr.addReference(n,t),this.Xr.delete(n.toString()),R.resolve()}removeReference(e,t,n){return this.Jr.removeReference(n,t),this.Xr.add(n.toString()),R.resolve()}markPotentiallyOrphaned(e,t){return this.Xr.add(t.toString()),R.resolve()}removeTarget(e,t){this.Jr.gr(t.targetId).forEach(s=>this.Xr.add(s.toString()));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(e,t.targetId).next(s=>{s.forEach(i=>this.Xr.add(i.toString()))}).next(()=>n.removeTargetData(e,t))}zr(){this.Yr=new Set}jr(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return R.forEach(this.Xr,n=>{const s=U.fromPath(n);return this.ei(e,s).next(i=>{i||t.removeEntry(s,H.min())})}).next(()=>(this.Yr=null,t.apply(e)))}updateLimboDocument(e,t){return this.ei(e,t).next(n=>{n?this.Xr.delete(t.toString()):this.Xr.add(t.toString())})}Wr(e){return 0}ei(e,t){return R.or([()=>R.resolve(this.Jr.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Hr(e,t)])}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Xs=null;function Jo(){return Xs===null?Xs=function(){return 268435456+Math.round(2147483648*Math.random())}():Xs++,"0x"+Xs.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ce="WebChannelConnection";class nI extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const n=t.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.Do=n+"://"+t.host,this.vo=`projects/${s}/databases/${i}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${i}`}get Fo(){return!1}Mo(t,n,s,i,o){const c=Jo(),l=this.xo(t,n.toUriEncodedString());N("RestConnection",`Sending RPC '${t}' ${c}:`,l,s);const h={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(h,i,o),this.No(t,l,h,s).then(f=>(N("RestConnection",`Received RPC '${t}' ${c}: `,f),f),f=>{throw ss("RestConnection",`RPC '${t}' ${c} failed with error: `,f,"url: ",l,"request:",s),f})}Lo(t,n,s,i,o,c){return this.Mo(t,n,s,i,o)}Oo(t,n,s){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+dr}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),n&&n.headers.forEach((i,o)=>t[o]=i),s&&s.headers.forEach((i,o)=>t[o]=i)}xo(t,n){const s=eI[t];return`${this.Do}/v1/${n}:${s}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,n,s){const i=Jo();return new Promise((o,c)=>{const l=new yd;l.setWithCredentials(!0),l.listenOnce(_d.COMPLETE,()=>{try{switch(l.getLastErrorCode()){case si.NO_ERROR:const f=l.getResponseJson();N(Ce,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(f)),o(f);break;case si.TIMEOUT:N(Ce,`RPC '${e}' ${i} timed out`),c(new M(x.DEADLINE_EXCEEDED,"Request time out"));break;case si.HTTP_ERROR:const p=l.getStatus();if(N(Ce,`RPC '${e}' ${i} failed with status:`,p,"response text:",l.getResponseText()),p>0){let g=l.getResponseJson();Array.isArray(g)&&(g=g[0]);const E=g==null?void 0:g.error;if(E&&E.status&&E.message){const P=function(k){const $=k.toLowerCase().replace(/_/g,"-");return Object.values(x).indexOf($)>=0?$:x.UNKNOWN}(E.status);c(new M(P,E.message))}else c(new M(x.UNKNOWN,"Server responded with status "+l.getStatus()))}else c(new M(x.UNAVAILABLE,"Connection failed."));break;default:q()}}finally{N(Ce,`RPC '${e}' ${i} completed.`)}});const h=JSON.stringify(s);N(Ce,`RPC '${e}' ${i} sending request:`,s),l.send(t,"POST",h,n,15)})}Bo(e,t,n){const s=Jo(),i=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=Td(),c=Id(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(l.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(l.useFetchStreams=!0),this.Oo(l.initMessageHeaders,t,n),l.encodeInitMessageHeaders=!0;const f=i.join("");N(Ce,`Creating RPC '${e}' stream ${s}: ${f}`,l);const p=o.createWebChannel(f,l);let g=!1,E=!1;const P=new tI({Io:k=>{E?N(Ce,`Not sending because RPC '${e}' stream ${s} is closed:`,k):(g||(N(Ce,`Opening RPC '${e}' stream ${s} transport.`),p.open(),g=!0),N(Ce,`RPC '${e}' stream ${s} sending:`,k),p.send(k))},To:()=>p.close()}),D=(k,$,j)=>{k.listen($,L=>{try{j(L)}catch(B){setTimeout(()=>{throw B},0)}})};return D(p,$r.EventType.OPEN,()=>{E||(N(Ce,`RPC '${e}' stream ${s} transport opened.`),P.yo())}),D(p,$r.EventType.CLOSE,()=>{E||(E=!0,N(Ce,`RPC '${e}' stream ${s} transport closed`),P.So())}),D(p,$r.EventType.ERROR,k=>{E||(E=!0,ss(Ce,`RPC '${e}' stream ${s} transport errored:`,k),P.So(new M(x.UNAVAILABLE,"The operation could not be completed")))}),D(p,$r.EventType.MESSAGE,k=>{var $;if(!E){const j=k.data[0];G(!!j);const L=j,B=L.error||(($=L[0])===null||$===void 0?void 0:$.error);if(B){N(Ce,`RPC '${e}' stream ${s} received error:`,B);const V=B.status;let O=function(v){const w=ve[v];if(w!==void 0)return uf(w)}(V),I=B.message;O===void 0&&(O=x.INTERNAL,I="Unknown error status: "+V+" with message "+B.message),E=!0,P.So(new M(O,I)),p.close()}else N(Ce,`RPC '${e}' stream ${s} received:`,j),P.bo(j)}}),D(c,vd.STAT_EVENT,k=>{k.stat===fa.PROXY?N(Ce,`RPC '${e}' stream ${s} detected buffering proxy`):k.stat===fa.NOPROXY&&N(Ce,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{P.wo()},0),P}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xi(r){return new lv(r,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rn{constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}withConverter(e){return new Rn(this.firestore,e,this._query)}}class je{constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Bt(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new je(this.firestore,e,this._key)}}class Bt extends Rn{constructor(e,t,n){super(e,t,zi(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new je(this.firestore,null,new U(e))}withConverter(e){return new Bt(this.firestore,e,this._path)}}function ro(r,e,...t){if(r=pe(r),fp("collection","path",e),r instanceof wc){const n=te.fromString(e,...t);return mh(n),new Bt(r,null,n)}{if(!(r instanceof je||r instanceof Bt))throw new M(x.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=r._path.child(te.fromString(e,...t));return mh(n),new Bt(r.firestore,null,n)}}function Pn(r,e,...t){if(r=pe(r),arguments.length===1&&(e=Ed.newId()),fp("doc","path",e),r instanceof wc){const n=te.fromString(e,...t);return ph(n),new je(r,null,new U(n))}{if(!(r instanceof je||r instanceof Bt))throw new M(x.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=r._path.child(te.fromString(e,...t));return ph(n),new je(r.firestore,r instanceof Bt?r.converter:null,new U(n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class so{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new M(x.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ue(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ze{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let n;try{n=ze.makeFromUrl(e,t)}catch{return new ze(e,"")}if(n.path==="")return n;throw DT(e)}static makeFromUrl(e,t){let n=null;const s="([A-Za-z0-9.\\-_]+)";function i(B){B.path.charAt(B.path.length-1)==="/"&&(B.path_=B.path_.slice(0,-1))}const o="(/(.*))?$",c=new RegExp("^gs://"+s+o,"i"),l={bucket:1,path:3};function h(B){B.path_=decodeURIComponent(B.path)}const f="v[A-Za-z0-9_]+",p=t.replace(/[.]/g,"\\."),g="(/([^?#]*).*)?$",E=new RegExp(`^https?://${p}/${f}/b/${s}/o${g}`,"i"),P={bucket:1,path:3},D=t===xp?"(?:storage.googleapis.com|storage.cloud.google.com)":t,k="([^?#]*)",$=new RegExp(`^https?://${D}/${s}/${k}`,"i"),L=[{regex:c,indices:l,postModify:i},{regex:E,indices:P,postModify:h},{regex:$,indices:{bucket:1,path:2},postModify:h}];for(let B=0;B<L.length;B++){const V=L[B],O=V.regex.exec(e);if(O){const I=O[V.indices.bucket];let y=O[V.indices.path];y||(y=""),n=new ze(I,y),V.postModify(n);break}}if(n==null)throw xT(e);return n}}class jT{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class En{constructor(e,t){this._service=e,t instanceof ze?this._location=t:this._location=ze.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new En(e,t)}get root(){const e=new ze(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Fp(this._location.path)}get storage(){return this._service}get parent(){const e=iE(this._location.path);if(e===null)return null;const t=new ze(this._location.bucket,e);return new En(this._service,t)}_throwIfRoot(e){if(this._location.path==="")throw MT(e)}}function EE(r,e,t){r._throwIfRoot("uploadBytes");const n=vE(r.storage,r._location,Bp(),new xt(e,!0),t);return r.storage.makeRequestWithTokens(n,Gp).then(s=>({metadata:s,ref:r}))}function wE(r){r._throwIfRoot("getDownloadURL");const e=gE(r.storage,r._location,Bp());return r.storage.makeRequestWithTokens(e,Gp).then(t=>{if(t===null)throw LT();return t})}function bE(r,e){const t=oE(r._location.path,e),n=new ze(r._location.bucket,t);return new En(r.storage,n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ni=new za("@firebase/auth");function ME(r,...e){Ni.logLevel<=Y.WARN&&Ni.warn(`Auth (${bn}): ${r}`,...e)}function fi(r,...e){Ni.logLevel<=Y.ERROR&&Ni.error(`Auth (${bn}): ${r}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ma(){var r;return typeof self<"u"&&((r=self.location)===null||r===void 0?void 0:r.href)||""}function jE(){return Ah()==="http:"||Ah()==="https:"}function Ah(){var r;return typeof self<"u"&&((r=self.location)===null||r===void 0?void 0:r.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function FE(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(jE()||Dg()||"connection"in navigator)?navigator.onLine:!0}function BE(){if(typeof navigator>"u")return null;const r=navigator;return r.languages&&r.languages[0]||r.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class As{constructor(e,t){this.shortDelay=e,this.longDelay=t,It(t>e,"Short delay should be less than long delay!"),this.isMobile=Cg()||Vg()}get(){return FE()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ss extends uo{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dt extends Ss{constructor(){super("facebook.com")}static credential(e){return wn._fromParams({providerId:Dt.PROVIDER_ID,signInMethod:Dt.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Dt.credentialFromTaggedObject(e)}static credentialFromError(e){return Dt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Dt.credential(e.oauthAccessToken)}catch{return null}}}Dt.FACEBOOK_SIGN_IN_METHOD="facebook.com";Dt.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ho{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const t=this.receivers.find(s=>s.isListeningto(e));if(t)return t;const n=new ho(e);return this.receivers.push(n),n}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const t=e,{eventId:n,eventType:s,data:i}=t.data,o=this.handlersMap[s];if(!(o!=null&&o.size))return;t.ports[0].postMessage({status:"ack",eventId:n,eventType:s});const c=Array.from(o).map(async h=>h(t.origin,i)),l=await Sw(c);t.ports[0].postMessage({status:"done",eventId:n,eventType:s,response:l})}_subscribe(e,t){Object.keys(this.handlersMap).length===0&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(t)}_unsubscribe(e,t){this.handlersMap[e]&&t&&this.handlersMap[e].delete(t),(!t||this.handlersMap[e].size===0)&&delete this.handlersMap[e],Object.keys(this.handlersMap).length===0&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}ho.receivers=[];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ta="webStorageSupport";class Sb{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=_m,this._completeRedirectFn=Jw,this._overrideRedirectResult=Kw}async _openPopup(e,t,n,s){var i;It((i=this.eventManagers[e._key()])===null||i===void 0?void 0:i.manager,"_initialize() not called before _openPopup()");const o=await jh(e,t,n,Ma(),s);return Ib(e,o,Qc())}async _openRedirect(e,t,n,s){await this._originValidation(e);const i=await jh(e,t,n,Ma(),s);return Pw(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(It(i,"If manager is not set, promise should be"),i)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch(()=>{delete this.eventManagers[t]}),n}async initAndGetManager(e){const t=await pb(e),n=new Xw(e);return t.register("authEvent",s=>(K(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:n.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(ta,{type:ta},s=>{var i;const o=(i=s==null?void 0:s[0])===null||i===void 0?void 0:i[ta];o!==void 0&&t(!!o),ot(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=rb(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return um()||sm()||Kc()}}const Rb=Sb;var Fh="@firebase/auth",Bh="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
      ...
      `}),n=await Promise.all(t);e.innerHTML=n.join(""),e.querySelectorAll(".rs-edit-q").forEach(i=>{i.addEventListener("click",o=>{const c=o.target.closest(".rs-edit-q").dataset.id,l=Ct.find(h=>h.id===c);l&&(document.getElementById("rs-modal-title").textContent=_("editNote")||"項目の編集",document.getElementById("rs-note-id").value=l.id,document.getElementById("rs-question").value=l.question,document.getElementById("rs-modal").classList.add("active"))})}),e.querySelectorAll(".rs-delete-q").forEach(i=>{i.addEventListener("click",async o=>{const c=o.target.closest(".rs-delete-q").dataset.id;confirm(_("confirmDelete")||"この項目を削除しますか？")&&(await Kb(r,c),await this.loadNotes(r))})});let s;e.querySelectorAll(".rs-answer-input").forEach(i=>{i.addEventListener("input",o=>{clearTimeout(s);const c=o.target.dataset.id,l=o.target.value;s=setTimeout(async()=>{await Hh(r,c,{answer:l})},1e3)})})}},Xh={food:{icon:"🍽️",label:_("catFood")||"食事"},transport:{icon:"🚕",label:_("catTransport")||"交通"},shopping:{icon:"🛒",label:_("catShopping")||"買い物"},stay:{icon:"🏨",label:_("catStay")||"宿泊"},activity:{icon:"🎭",label:_("catActivity")||"アクティビティ"},other:{icon:"📦",label:_("catOther")||"その他"}},vA={render(){return`
        ...
        `},async init(){var g,E;(g=document.getElementById("btn-back-budget"))==null||g.addEventListener("click",()=>oe("/"));const r=ne(),e=r.currentTripId,t=document.getElementById("budget-main");if(!e){t.innerHTML=`
                <div class="empty-state">
                    ...
                    </div>`;return}const P=i.reduce((L,B)=>L+Number(B.amount),0),D={};n.forEach(L=>D[L]=0),i.forEach(L=>{D[L.paidBy]!==void 0&&(D[L.paidBy]+=Number(L.amount))});const k=P/n.length;let $=`
                <div class="budget-summary card mb-md">
                    ...
                    <div class="warikan-summary mt-md pt-md" style="border-top: 1px solid var(--border-light)">
                        ...
                        ${Object.entries(D).map(([L,B])=>{const V=B-k,O=V>=0?"var(--color-mint)":"var(--color-pink-deep)",I=V>=0?`+¥${Math.round(V).toLocaleString()}`:`-¥${Math.round(Math.abs(V)).toLocaleString()}`;return`
                                <div class="flex-between mb-xs text-sm">
                                    <span>${L}</span>
                                    <div class="text-right">
                                        <div style="color: ${O}; font-weight: bold;">${I}</div>
                                        <div class="text-xs text-muted">(${_("youPaid")||"あなたが払った"}: ¥${B.toLocaleString()})</div>
                                    </div>
                                </div>
                            `}).join("")}
                    </div>
                ...
                <div class="budget-list">
                    <h3>${_("budgetListTitle")||"支出リスト 📝"}</h3>`;for(const L of i){const B=await Ke(L.title)||"無題",V=await Ke(L.paidBy)||L.paidBy;$+=`
        ...
        `},async init(){var p;(p=document.getElementById("btn-back-omiyage"))==null||p.addEventListener("click",()=>oe("/"));const e=ne().currentTripId,t=document.getElementById("omiyage-main"),n=document.getElementById("omiyage-progress-container");if(!e){t.innerHTML=`
            ...
            `;const P={};for(const $ of s){const j=await Ke($.recipientName)||$.recipientName;P[j]||(P[j]=[]),P[j].push($)}const D=Object.keys(P).map(async $=>{const j=P[$],L=j.reduce((O,I)=>O+Number(I.budget||0),0),B=j.map(async O=>{const I=await Ke(O.itemName)||_("undecided")||"未定";return`
